...
<div class="container">
	<div class="row">
		...
		<div class="top-side">
			...
			<form class="biv-btn" action="" method="post" enctype="multipart/form-data">
				<select name="msg_sort" class="form-control biv-btn"  onchange="this.form.submit()">
					...
					<option value="1" id="inbox">Newest first</option>
        ...
        <?php echo form_open('main/delete_inbox');?>
				...
				<tbody>               
                    ...
                    ?>              
						<tr class="<?php echo $unseen; ?>">
							...
							<td><a href="<? echo base_url();?>main/show_message/inbox/<?php echo trim($headers[$i]->Msgno); ?>" class="loader" ><?php echo $CI->imap->decode_utf8(isset($headers[$i]->subject)? $headers[$i]->subject : 'no subject'); ?></a></td>
